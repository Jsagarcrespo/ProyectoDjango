...
urlpatterns = [
    ...
    path('<int:encuesta_id>/preguntas/<int:pregunta_id>/opciones/<int:opcion_id>/editar/',views.editar_opcion,name='editar_opcion'),
    path('<int:encuesta_id>/preguntas/<int:pregunta_id>/opciones/<int:opcion_id>/eliminar/',views.eliminar_opcion,name='eliminar_opcion'),
